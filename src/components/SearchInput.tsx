        ...
        <div className={`relative ${className}`}>
            <form onSubmit={handleSearch} className="flex">
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className="absolute right-2 top-2 w-24 h-12 bg-blue-500 text-white text-lg font-light rounded-lg hover:bg-blue-600 transition-colors focus:outline-none focus:ring-2 focus:ring-eosc-light-blue focus:ring-offset-2"
                >
                    Search
                </button>
            </form>
